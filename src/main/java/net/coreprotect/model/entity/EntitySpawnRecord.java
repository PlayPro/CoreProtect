...
public final class EntitySpawnRecord {
    ...
    public EntitySpawnRecord(int rowId, long blockRowId, int killRowId, UUID uuid, int originalWorldId, double originalX, double originalY, double originalZ, int worldId, double x, double y, double z, float yaw, float pitch, boolean removed, List<Object> state) {
        this.rowId = rowId;
