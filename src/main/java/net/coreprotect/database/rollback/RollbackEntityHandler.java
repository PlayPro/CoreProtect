...
public class RollbackEntityHandler {
    ...
    public static int processEntity(int rollbackType, String finalUserString, int oldTypeRaw, int rowTypeRaw, int rowData, int rowAction, int rowRolledBack, int rowX, int rowY, int rowZ, int rowWorldId, int rowUserId, String rowUser) {
        ...
        int count = processEntity(bukkitWorld, oldTypeRaw, rowTypeRaw, rowData, rowAction, rowRolledBack, rowX, rowY, rowZ, rowWorldId, rowUser);
        if (count > 0) {
            updateEntityCount(finalUserString, count);
        }
        return count;
    }
    ...
    public static void updateEntityCount(String userString, int increment) {
        ...
        int entityCount = rollbackHashData[2] + increment;
