...
public final class BlockGroup {
    ...
    public static Set<Material> SIGNS = new HashSet<>(Arrays.asList(Material.OAK_SIGN, Material.SPRUCE_SIGN, Material.BIRCH_SIGN, Material.JUNGLE_SIGN, Material.ACACIA_SIGN, Material.DARK_OAK_SIGN, Material.CRIMSON_SIGN, Material.WARPED_SIGN, Material.CHERRY_SIGN, Material.MANGROVE_SIGN, Material.PALE_OAK_SIGN, Material.BAMBOO_SIGN,
                                                                    Material.OAK_WALL_SIGN, Material.SPRUCE_WALL_SIGN, Material.BIRCH_WALL_SIGN, Material.JUNGLE_WALL_SIGN, Material.ACACIA_WALL_SIGN, Material.DARK_OAK_WALL_SIGN, Material.WARPED_WALL_SIGN, Material.CHERRY_WALL_SIGN, Material.MANGROVE_WALL_SIGN, Material.PALE_OAK_WALL_SIGN, Material.BAMBOO_WALL_SIGN,
                                                                    Material.OAK_HANGING_SIGN, Material.SPRUCE_HANGING_SIGN, Material.BIRCH_HANGING_SIGN, Material.JUNGLE_HANGING_SIGN, Material.ACACIA_HANGING_SIGN, Material.DARK_OAK_HANGING_SIGN, Material.WARPED_HANGING_SIGN, Material.CHERRY_HANGING_SIGN, Material.MANGROVE_HANGING_SIGN, Material.PALE_OAK_HANGING_SIGN, Material.BAMBOO_HANGING_SIGN,
                                                                    Material.OAK_WALL_HANGING_SIGN, Material.SPRUCE_WALL_HANGING_SIGN, Material.BIRCH_WALL_HANGING_SIGN, Material.JUNGLE_WALL_HANGING_SIGN, Material.ACACIA_WALL_HANGING_SIGN, Material.DARK_OAK_WALL_HANGING_SIGN, Material.WARPED_WALL_HANGING_SIGN, Material.CHERRY_WALL_HANGING_SIGN, Material.MANGROVE_WALL_HANGING_SIGN, Material.PALE_OAK_WALL_HANGING_SIGN, Material.BAMBOO_WALL_HANGING_SIGN));
