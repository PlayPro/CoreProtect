...
public class TabHandler implements TabCompleter {
    ...
    private static String[] HELP = new String[] { "inspect", "rollback", "restore", "lookup", "purge", "teleport", "status", "params", "users", "time", "radius", "action", "include", "exclude", "networking" };
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (sender.hasPermission("coreprotect.networking")) {
                completions.add("networking");
            }
