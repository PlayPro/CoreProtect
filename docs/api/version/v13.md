...
- Added a typed container lookup method:
```java
...
Ensure you're using CoreProtect 24.1 or higher. Add it as an external jar to your plugin in your IDE.
Alternatively, if using Maven, you can add it via the repository https://maven.playpro.com (net.coreprotect, 24.1).
...
The returned `ContainerResult` entries provide typed access to the following:
