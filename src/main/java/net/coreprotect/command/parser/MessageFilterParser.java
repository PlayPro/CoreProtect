...
public final class MessageFilterParser {
    ...
    private static boolean isControl(String normalized) {
        return normalized.equals("#count") || normalized.equals("#sum") || normalized.equals("#summary") || normalized.equals("count") || normalized.equals("sum") || normalized.equals("summary")
