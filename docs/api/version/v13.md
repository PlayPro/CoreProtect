...
| Tracked containers | Container and inventory lookups include transactions in tracked boats and minecarts, plus chest-equipped donkeys, mules, llamas, and trader llamas. |
...
Tracked entity-container transactions follow the location rules described under container lookups and remain part of the public `container` source.
