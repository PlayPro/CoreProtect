...
public class Queue {
    ...
    protected static void queueEntityKill(String user, Location location, EntityType type, String entityData) {
        queueStandardData(new Object[] { null, Process.ENTITY_KILL, null, 0, null, 0, 0 }, new String[] { user, null }, new Object[] { getBlockLocation(location), type, entityData }, false, Consumer.reserveConsumer());
    }
    ...
    protected static void queuePlayerChat(Player player, String message, long timestamp, boolean cancelled) {
        queueStandardData(new Object[] { null, Process.PLAYER_CHAT, null, 0, null, 0, 0, null }, new String[] { player.getName(), null }, new Object[] { timestamp, player.getLocation().clone(), cancelled }, false, Consumer.consumerStrings, message, Consumer.reserveConsumer());
    }

    protected static void queuePlayerCommand(Player player, String message, long timestamp, boolean cancelled) {
        queueStandardData(new Object[] { null, Process.PLAYER_COMMAND, null, 0, null, 0, 0, null }, new String[] { player.getName(), null }, new Object[] { timestamp, player.getLocation().clone(), cancelled }, false, Consumer.consumerStrings, message, Consumer.reserveConsumer());
    }
    ...
    protected static void queueRollbackUpdate(String user, List<CommonLookupData> lookup, int table, int action) {
        ...
        queueStandardData(new Object[] { null, table, null, 0, null, 0, action, null }, new String[] { user, null }, lookup, false, Consumer.reserveConsumer());
    }
