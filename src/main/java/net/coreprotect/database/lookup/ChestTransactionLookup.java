    ...
    public static String performLookup(String command, Statement statement, Location l, CommandSender commandSender, int page, int limit, boolean exact) {
        ...
        try {
            ...
            while (results.next()) {
                ...
                PluginChannelListener.getInstance().sendData(commandSender, timeAgo, Phrase.LOOKUP_CONTAINER, selector, resultUser, target, resultAmount, x, y, z, worldId, rbFormat);
            }
