...
public final class BlockGroup {
    ...
    public static Set<Material> TRACK_TOP_BOTTOM = new HashSet<>(Collections.emptyList());
    ...
    public static Set<Material> TRACK_BOTTOM = new HashSet<>(Collections.emptyList());
    ...
    public static Set<Material> VINES = new HashSet<>(Collections.singletonList(Material.VINE));
    public static Set<Material> AMETHYST = new HashSet<>(Collections.emptyList());
    public static Set<Material> LIGHTABLES = new HashSet<>(Collections.singletonList(Material.CAMPFIRE));
    public static Set<Material> CANDLES = new HashSet<>(Collections.emptyList());
    public static Set<Material> FIRE = new HashSet<>(Collections.singletonList(Material.FIRE));
    public static Set<Material> LANTERNS = new HashSet<>(Collections.singletonList(Material.LANTERN));
    public static Set<Material> SOUL_BLOCKS = new HashSet<>(Collections.singletonList(Material.SOUL_SAND));
    ...
    public static Set<Material> VERTICAL_TOP_BOTTOM = new HashSet<>(Collections.emptyList());
    public static Set<Material> VERTICAL_TOP = new HashSet<>(Collections.emptyList());
    public static Set<Material> VERTICAL_BOTTOM = new HashSet<>(Collections.emptyList());
    public static Set<Material> VERTICAL = new HashSet<>(Collections.emptyList());
